    ...
    return (
        <>
            <div className="flex flex-col w-full h-full">
                <span className="text-center xl:text-3xl text-2xl flex text-white pb-3 self-center">Redes</span>
                <div className="flex flex-row justify-between xl:grid grid-cols-2 w-full h-max place-items-center ">
