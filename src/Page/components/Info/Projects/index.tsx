...
export default function Projects() {
  ...
  return (
    <Container className="flex flex-col gap-2 items-center">
      <div className="col-span-3 flex xl:text-3xl text-2xl w-full h-max justify-center text-center">
        Projetos
      </div>
      <Row className="grid justify-items-center grid-cols-3 grid-rows-3 gap-2 h-max w-full">
        <Col
          className=" col-span-1 xl:div-span-1 div-span-1 border-2 rounded-xl w-max h-full justify-between items-center self-center  border-red-600  "
          onMouseEnter={() => {
            setIsOpen(true);
            handleDialog();
          }}
        >
          <span className="flex p-2 xl:flex-row flex-col items-center h-full w-full justify-center">
        ...
        <Col
          className="col-span-1 xl:row-span-1 row-span-1 border-2 rounded-xl h-max w-max justify-center justify-items-center self-center border-purple-600"
          onMouseEnter={() => {
            setIsOpen3(true);
            handleDialog();
          }}
        ...
        <Col className="row-span-2  justify-center items-center xl:row-span-1 xl:col-span-3">
          <span className="flex gap-2 col-span-3 flex-col h-full items-center xl:flex-row animate-pulse">
