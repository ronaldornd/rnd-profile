...
export default function Share() {
    return (
        <div className="flex bg-zinc-800 rounded-xl border-green-800 flex-col border-2 p-10 h-full lg:w-full w-full gap-8 items-center justify-center ">
            <h1 className="text-4xl flex justify-self-center font-serif font-bold self-center">Compartilhe!</h1>
            <img src={qrImage} className='flex lg:w-46 h-46 w-max self-center' />
