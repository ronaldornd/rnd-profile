...
export default function Share() {
    return (
        <div className="flex bg-zinc-800 rounded-xl border-green-800 flex-col border-2 p-10 h-max w-max gap-8 items-center justify-center ">
            <h1 className="text-4xl flex justify-self-center font-serif font-bold self-center">Compartilhe!</h1>
            <img src={qrImage} className='flex h-40 w-40 self-center' />
